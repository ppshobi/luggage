            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <h3 class="card-title">Add storage facility</h3>
                        <form action="{{ route('storage.store') }}" method="post" class="form">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right">Facility Name</label>

                                <div class="col-md-6">
                                    <input id="name" type="name" placeholder="Storage Locker/Parking" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
